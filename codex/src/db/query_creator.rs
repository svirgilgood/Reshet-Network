...
//impl From<TemplateError> for Err {}
//impl From<RenderError> for Err {}
...
pub fn update_query(
    add: Option<&str>,
    delete: Option<&str>,
    graph_pattern: Option<&str>,
) -> Result<String, TemplateError> {
    let mut handlebars = Handlebars::new();
    handlebars.register_template_file("insert", "./src/db/queries/insert.sparql")?;
    ...
    let res = handlebars.render("insert", &replacement_dic)?;
    return Ok(res);
}
...
mod tests {
    ...
    fn create_graph_vec() {
        ...
        assert_eq!(
            example,
            "<https://example.com/Bob> <https://example.com/knows> <https://example.com/Alice>.\n"
        );
    }
